...
public class VirtualController {
    ...
    public String virtualGuardar(@ModelAttribute Virtual virtual) {
        virtualRepository.insertarVirtual(virtual.getDireccion(), virtual.getTipoPunto(), virtual.getPlataforma());
    ...
    public String virtualEditarGuardar(@PathVariable("id") Integer id, @ModelAttribute Virtual virtual){
        virtualRepository.actualizarVirtual(virtual.getId(), virtual.getDireccion(), virtual.getTipoPunto(), virtual.getPlataforma());
        return "redirect:/virtuales";
    }
